...
\begin{frame}
    ...
    \includegraphics[height=\textheight]{./cabi_stations.png}
\end{frame}
\begin{frame}
    \frametitle{The data}
...
\end{frame}
\subsection{Goal 1: How many unique trips}
...
\begin{frame}
    ...
    \includegraphics[height=\textheight]{./cabi_with_number_of_trips.png}
\end{frame}
\subsection{Goal 2: Routing the trips}
\begin{frame}
...
\end{frame}
\subsection{Goal 3: How to combine it all}
\begin{frame}
    \frametitle{Back to Goal 3}
    \framesubtitle{How many bikeshare trips by street}
...
\begin{frame}
    \frametitle{Results}
    \includegraphics[height=0.9\textheight]{./network_stats.jpg}
\end{frame}
\begin{frame}
